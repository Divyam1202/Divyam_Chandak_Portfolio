...
const ProjectItem = ({ title, backgroundImg, projectUrl, description, click }) => {
  return (
    <a
      href={projectUrl}
      target='_blank'
      rel='noopener noreferrer'
      className='group block cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff9100] focus-visible:ring-offset-4 rounded-xl'
