    ...
    <div id='blogs' className='w-full h-full' style={{ backgroundColor: '#ffffff' }}>
      ...
      <div className='max-w-[1240px] mx-auto px-2 py-4'>
        <div className='mb-8'>
          ...
          <a href='https://medium.com/@DSCdev/swin-transformers-for-semantic-segmentation-part-1-bd85bad7e051' target='_blank' rel='noreferrer' className='text-blue-600 hover:underline'>
            Read on Medium
          </a>
        </div>
        ...
        <div className='mb-8'>
          ...
          <a href='https://medium.com/@DSCdev/understanding-multi-headed-yolo-v9-for-object-detection-and-segmentation-8923ee21b652' target='_blank' rel='noreferrer' className='text-blue-600 hover:underline'>
            Read on Medium
          </a>
        </div>

        <div className='mb-8'>
          <h3 className='text-xl font-semibold'>HingFlow - Building Your Own English to Hindi Translation Model</h3>
          <p className='text-sm text-muted mb-2'>A walkthrough for creating HingFlow, including training and deployment notes.</p>
          <a href='https://divyamchandak.substack.com/p/hingflow-building-your-own-english' target='_blank' rel='noreferrer' className='text-blue-600 hover:underline'>
            Read on Substack
          </a>
        </div>

        <p className='text-sm text-muted mt-6'>Want more blogs added here? Tell me which posts or source feed to use, and I will add them with excerpts and dates.</p>
      </div>
    </div>
  );
};
